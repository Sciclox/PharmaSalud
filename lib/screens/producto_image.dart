...
class FormularioImage extends StatefulWidget {
  @override
  _FormularioProductoState createState() => _FormularioProductoState();
}

class _FormularioProductoState extends State<FormularioImage> {
...
Future<void> _pickImage() async {
  ...
  if (pickedFile != null) {
    ...
    // Convertir la imagen a bytes para almacenarla como BLOB en la base de datos
    final bytes = await pickedFile.readAsBytes();
    imagenProducto = bytesToBase64(bytes);
  }
}
